...
<body>
    <div class="wrapper">
        ...
        <h4 class="noto-bold" style="line-height: 30px; margin-bottom: 20px">비밀번호 입력</h4>
        <div class="login" style="margin: 80px 0 40px 0">
            <form action="register_check.php" method="post">
                <p class="main-notice">회원가입시 등록하셨던 비밀번호를 입력해주세요</p>
                <div class="row">
                    <div class="col-1"></div>
                    <div class="col-10">
                        <input type="passwd" class="form-control form-control-lg" name="passwd" placeholder="비밀번호 입력" style="font-size:16px; text-align:center" max-length="4" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4"></div>
